...
def processProfile(request):
    ...
    response = JsonResponse({'values':{"username": username.lower(), "realName": realName, "blabName": blabName},'message':jsonify(msg)}, status=200)
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(update % (realName, blabName, sessionUsername), (realName,))
